describe('Test pages component', () => {
    ...
    it('validation error highlighting on tabs', () => {
        ...
        cy.get('.tabs ul li').eq(2).find('a').click();
        cy.get('textarea[name="comments"]').type('Some comments');
        ...
        cy.get('.tabs ul li').eq(0).should('have.class', 'is-danger'); // Page 1 has missing first_name
        cy.get('.tabs ul li').eq(1).should('have.class', 'is-danger'); // Page 2 has missing email and address
        cy.get('.tabs ul li').eq(2).should('have.class', 'is-danger'); // Page 3 has missing contact_method
    });
    ...
    it('successful form submission', () => {
        ...
        // Page 3
        cy.get('.tabs ul li').eq(2).find('a').click();
        cy.get('input[name="contact_method"][value="Email"]').click();
